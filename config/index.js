export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx08da1fbd27283f8e",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b3d28bd028b1d8eefc6f19fc3b7cf7b6",
  ...
  USERS: [
    {
      ...
      id: "of9PH6EgYNB83M5ubcA11wVqAwCM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "kyUDy8WvtkQdiSb2kd6Gy-Ba5at32947rsn8dWTS1kg",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "苏州",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "憨憨", "year": "2001", "date": "09-09"},
        {"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "憨憨", "year": "2001", "date": "09-16"},
